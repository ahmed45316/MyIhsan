var Layout = function () {
    var e = "layouts/layout/img/",
        ...
        s = function (e, a) {
            ...
            if ("click" === e || "set" === e ? a = $(a) : "match" === e && s.find("li > a").each(function () {
            ...
            }), a && 0 != a.length && "javascript:;" !== a.attr("href").toLowerCase() && "#" !== a.attr("href").toLowerCase()) {
                ...
                s.hasClass("page-sidebar-menu-hover-submenu") === !1 ? s.find("li.nav-item.open").each(function () {
                    ...
                    $(this).addClass("active"), $(this).find("> a > span.arrow").addClass("open"), 1 === $(this).parent("ul.page-sidebar-menu").length && $(this).find("> a").append('<span class="selected"></span>'), 1 === $(this).children("ul.sub-menu").length && $(this).addClass("open")
        ...
        o = function () {
            $(".page-sidebar-menu").on("click", "li > a.nav-toggle, li > a > span.nav-toggle", function (e) {
                ...
                if (!(App.getViewPort().width >= t && !$(".page-sidebar-menu").attr("data-initialized") && $("body").hasClass("page-sidebar-closed") && 1 === a.parent("li").parent(".page-sidebar-menu").length)) {
                    var s = a.next().hasClass("sub-menu");
                    if (!(App.getViewPort().width >= t && 1 === a.parents(".page-sidebar-menu-hover-submenu").length)) {
                ...
                $.ajax({
                    ...
                    dataType: "html",
                    success: function (e) {
                        0 === o.parents("li.open").length && $(".page-sidebar-menu > li.open > a").click(), App.stopPageLoading(), s.html(e), Layout.fixContentHeight(), App.initAjax()
                    },
                ...
                e.preventDefault(), $("body").hasClass("page-sidebar-closed") && $(".sidebar-search").hasClass("open") === !1 ? (1 === $(".page-sidebar-fixed").length && $(".page-sidebar .sidebar-toggler").click(), $(".sidebar-search").addClass("open")) : $(".sidebar-search").submit()
            }), 0 !== $(".sidebar-search").length && ($(".sidebar-search .input-group").on("click", function (e) {
                e.stopPropagation()
        ...
        r = function () {
            ...
            return App.destroySlimScroll(e), 0 === $(".page-sidebar-fixed").length ? void i() : void (App.getViewPort().width >= t && (e.attr("data-height", n()), App.initSlimScroll(e), i()))
        },
        d = function () {
            var e = $("body");
